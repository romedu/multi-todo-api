...
exports.todoListBaseUrl = "/api/todos";

exports.createFolderIdUrl = folderId => createResourceUrl(this.folderBaseUrl, folderId);

exports.createTodoListIdUrl = todoListId => createResourceUrl(this.todoListBaseUrl, todoListId);
